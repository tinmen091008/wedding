...
<div id="page-shops">
    <div class="layout_center">
        <div class="path">
            ...
            <em>&gt;</em>
            <a href="javascript:;" class="page cur">${hotel.hotel_name}</a>
        </div>
        <div id="shops-header" class="header layout_clear">
            <div class="shops-cover layout_fl">
                <img src="images/${hotel.hotel_img}" />
            </div>
            <div class="shops-deta layout_clear layout_fl">
                ...
                <div class="shops-label layout_fl">
                    <h4 class="shops-label-name">${hotel.hotel_name}</h4>
                            ...
                            <div class="shops-gdx-trans">
                                ...
                                <div class="shops-trans-teble">
                                    ...
                                    <table>
                                        <tbody>
                                        <tr>
                                            <td><span class="lab">空高</span><span>${room.room_height}</span></td>
                                            <td><span class="lab">柱子</span><span>${room.room_pillar}</span></td>
                                            <td><span class="lab">形状</span><span>${room.room_form}</span></td>
                                        </tr>
                                        <tr>
                                            <td><span class="lab">低消</span><span>${room.room_min_fee}</span></td>
                                            <td><span class="lab">面积</span><span>${room.room_area}</span></td>
                                            <td><span class="lab">拆分</span><span>${room.room_split}</span></td>
                                        </tr>
                                        <tr>
                                            <td><span class="lab">电费</span><span>${room.room_ele_fee}</span></td>
                                            <td><span class="lab">晚餐</span><span>${room.room_dinner}</span></td>
                                            <td><span class="lab">桌数</span><span>${room.room_tables}</span></td>
                                        </tr>
                                        <tr>
                                            <td><span class="lab">LED</span><span>${room.room_LED}</span></td>
                                            <td><span class="lab">灯光</span><span>${room.room_lamplight}</span></td>
                                        </tr>
                                        </tbody>
                                    </table>
                                </div>
            ...
            <div class="shops-grids">
                ...
                <div class="shops-gdx-wrap">
                    <div class="shops-gdx-transdx">
							...
							<!--百度地图容器-->
  							<div class="shops-transdx-map" id="dituContent"></div>
							<div class="shops-transdx-data">
								<div class="shops-transdx-table">
									<ul>
										...
										<li style="width: 193.5px"><span class="lab">3订金</span><span >200</span></li>
										...
										<li style="width: 193.5px"><span class="lab">11电费</span><span >${hotelInfo.info_electric_charge}</span></li>
                ...
                <div class="shops-gdx-wrap">
                    <ul class="shops-gdx-list2 layout_clear fl_li" data-region="1">
                        ...
                        <li> <a href="#">
                            <div>
                                <div class="gdx-img">
                                    <img src="images/${pack.package_img1}" style="width: 100%;" />
                                </div>
                                <div class="gdx-data">
                                    <div class="gdx-name">
                                        ${pack.package_name }
                                    ...
                                    <div class="gdx-price">
                                        <span class="price-strong">￥${pack.package_price}</span>
                                        <!--<span class='price-text'>原价<span class='price-through'></span></span>-->
                                    </div>
                                    <div class="gdx-label">
                                        <p class="label-line"><span>产品摘要：</span>${pack.package_content}</p>
                                        <p class="label-line"><span>销量：</span>${pack.package_sales}</p>
                                    </div>
                                </div>
                            </div> </a> 
							</li>
