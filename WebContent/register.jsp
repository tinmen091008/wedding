			...
			<div class="user-form-wrap">
				<div class="user-form-wraps">
					<div class="user-form-item">
						<strong class="user-form-title">会员注册</strong>
					</div>
					<!-- 错误提示文字 -->
					<span style="color: red"> ${error_msg}</span>
					<form data-form="userlogin" action="register.do" method="post">
						<div class="user-form-item">
							<input class="user-input" name="user_tel" type="text" max="15"
								maxlength="15" placeholder="手机号" onblur="checkTel()">
						</div>
						<div id="tel_msg"></div>
						<div class="user-form-item">
							<input class="user-input" name="password" type="password"
								max="15" maxlength="15" placeholder="6-16位密码">
						</div>
						<div class="user-form-item">
							<label> <input class="user-check" name="aggree"
								type="checkbox" checked="false" value="yes">&nbsp; <span
								class="cos_span">注册即表示同意 <a href="javascript:;"
					...
					<div class="user-form-item us_text_right">
						<span class="cos_span_empty"> <a href="login.jsp">登录账号</a></span>
					</div>
				</div>
			</div>
		</div>
